...
class Calculator:
    ...
    def equal_button_press(self):
        if self.add_trigger or self.trigger or self.mult_trigger or self.div_trigger:
            if self.add_trigger:
    ...
    def __init__(self,root):
        ...
        self.button_press('/')).grid(row=1,column=3)
        ...
        self.button_press('*')).grid(row=2,column=3)
        ...
        self.button_press('+')).grid(row=3,column=3)
        ...
        self.button_press()).grid(row=4,column=2)

        self.button_sub=ttk.Button(root, text="-", command=lambda:
        self.button_press('-')).grid(row=4,column=3)
